...
{
  unset($_SESSION['modules']['Obsadene']['calendar']['scope']);
}
...
elseif(isset($_SESSION['modules']['Obsadene']['calendar']['scope']))
{
  $scope = $_SESSION['modules']['Obsadene']['calendar']['scope'];
}
else
{
  $scope = time();
...
if(!isset($params['forget_scope']))
{
  $_SESSION['modules']['Obsadene']['calendar']['scope'] = $scope;
}
