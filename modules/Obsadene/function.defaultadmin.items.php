...
if(isset($_SESSION['Obsadene']['view']) && !isset($params['view']))
{
	$params['view'] = $_SESSION['Obsadene']['view'];
}
...
echo ObsadeneViews::adminItems($this,$id,$returnid,$view,$items);	

$_SESSION['Obsadene']['view'] = $view->getView();