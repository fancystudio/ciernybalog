...
if ($publishing_checks && (!(isset($params['preview_key']) && $_SESSION['Obsadene']['preview_key'] == $params['preview_key'])))
{
	$c->add('published', '1');	
	ObsadeneObject::globalFrontendFilters($c);
}

$item = ObsadeneObject::doSelectOne($c);
...
if (isset($params['var'])) {
    ...
    $this->smarty->assign('Obsadene', $item);
